    ...
    <section class="section-signin clearfix">
        <div class="box-signin-mx">
            ...
            <div class="box-input-signin">
                ...
                <div class="d-flex justify-content-around mb10">
                    <div>
                        <a href="javascript:void(0)" id="forget-pass" class="text-white"> <i class="fa fa-cog" aria-hidden="true"></i>&nbsp;Quên mật khẩu</a>
                    </div>
                </div>
