    ...
    <ul class="metismenu" id="menu1">
        ...
        <li class="<?=($com=='baiviet' && ($_GET['type']=='dich-vu')) ? "active" :""?>">
            ...
            <ul aria-expanded="<?=($com=='baiviet' && ($_GET['type']=='dich-vu')) ? "true" :"false"?>"
                ...
                <li
                    ...
                    <a href="index.php?com=baiviet&act=man_list&tbl=list&type=dich-vu&page=1">Danh mục cấp
                        1</a>

                </li>
                <li class="<?=($com=='baiviet' && $act=='man' && 'dich-vu'==$_GET['type']) ? "this" :""?>">

                    <a href="index.php?com=baiviet&act=man&type=<?='dich-vu'?>&page=1">Danh sách dịch vụ</a>
        ...
        <li class="<?=($com=='baiviet' && ($_GET['type']=='bao-gia')) ? "active" :""?>">
            ...
            <ul aria-expanded="<?=($com=='baiviet' && ($_GET['type']=='bao-gia')) ? "true" :"false"?>"
                ...
                <li
                    class="<?=($com=='baiviet' && $act=='man_list' && 'bao-gia'==$_GET['type']) ? "this" :""?>">

                    <a href="index.php?com=baiviet&act=man_list&tbl=list&type=bao-gia&page=1">Danh mục cấp
                        1</a>

                </li>
                <li class="<?=($com=='baiviet' && $act=='man' && 'bao-gia'==$_GET['type']) ? "this" :""?>">

                    <a href="index.php?com=baiviet&act=man&type=<?='bao-gia'?>&page=1">Danh sách báo giá</a>
        ...
        <li
            <?=($com=='info' && ($_GET['type']=='gioi-thieu' ||$_GET['type']=='gioi-thieu-phai') ) ? ' class="active"' : '' ?>>
        ...
        <li class="<?=(($com=='contact' || $com=='booking' || $com=='newsletter') && $act=='man') ? "active" :""?>">
            ...
            <ul aria-expanded="<?=(($com=='contact' || $com=='booking' || $com=='newsletter') && $act=='man') ? "true" :"false"?>"
                ...
                <li <?php if($com=='newsletter' && $act=='man') echo ' class="this"' ?>><a
                        href="index.html?com=newsletter&act=man&type=nhan-tin" title="">Danh sách đk nhận tin</a></li>
