<?php  if(!defined('_source')) die("Error");
    ...
    if(!empty($idl)){
        ...
        if($row_list){
            ...
            $tintuc=$db->rawQuery("select *,tenkhongdau_$lang as tenkhongdau from #_baiviet where hienthi=1 $combo and id_list=? and type=? $order_by limit $startpoint,$per_page",array($row_list['id'],$type));
    ...
    if(!empty($idc)){
        ...
        if($row_cat){
            ...
            $tintuc=$db->rawQuery("select *,tenkhongdau_$lang as tenkhongdau from #_baiviet where hienthi=1 $combo and id_cat=? and type=? $order_by limit $startpoint,$per_page",array($row_cat['id'],$type));
    ...
    if(!empty($idi)){
        ...
        if($row_item){
            ...
            $tintuc=$db->rawQuery("select *,tenkhongdau_$lang as tenkhongdau from #_baiviet where hienthi=1 $combo and id_item=? and type=? $order_by limit $startpoint,$per_page",array($row_item['id'],$type));
    ...
    if(!empty($ids)){
        ...
        if($row_sub){
            ...
            $tintuc=$db->rawQuery("select *,tenkhongdau_$lang as tenkhongdau from #_baiviet where hienthi=1 $combo and id_sub=? and type=? $order_by limit $startpoint,$per_page",array($row_sub['id'],$type));
    ...
    if(empty($id) && empty($idl) && empty($idc) && empty($idi) && empty($ids)){
        ...
        $tintuc=$db->rawQuery("select *,tenkhongdau_$lang as tenkhongdau from #_baiviet where hienthi=1 $combo and type=? $order_by limit $startpoint,$per_page",array($type));
        ...
        $photos = $db->rawQuery("select id,photo , link from #_baiviet_photo where type=? and id_baiviet=? order by stt asc, id desc",array($type,$id));
        ...
        $tintuc=$db->rawQuery("select *,tenkhongdau_$lang as tenkhongdau from table_baiviet where hienthi=1 and type=?{$subWhere} order by stt asc, id desc",array($type));
