...
$GLOBAL_LEVEL2['baiviet'][$nametype]['title'] = 'Danh mục cấp 3';

$GLOBAL_LEVEL2['baiviet'][$nametype]['full'] = true;

$GLOBAL_LEVEL2['baiviet'][$nametype]['check_item']=array(
...
$GLOBAL_LEVEL2['baiviet'][$nametype]['img_type']='.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|.webp';
	...
	$GLOBAL['baiviet'][$nametype]['img-width'] = 600;

	$GLOBAL['baiviet'][$nametype]['img-height'] = 600;
...
#====================Hotline============================
	...
	$GLOBAL['bannerqc'][$nametype]['title_main'] = 'icon thiết kế thi công';

	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý icon thiết kế thi công';
	...
	$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý icon tin tức';
...
$GLOBAL['bannerqc'][$nametype]['title_main'] = 'background chữ';

$GLOBAL['bannerqc'][$nametype]['title'] = 'Quản lý background chữ';
...
$GLOBAL['bannerqc'][$nametype]['img_type']='.swf|.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF|.webp';
	...
	$GLOBAL['setting']['page_sp']=false;

	$GLOBAL['setting']['limit_sp']=true;
