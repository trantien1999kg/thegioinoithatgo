<script type="text/javascript">
    ...
    var _HOVATEN = [ "HỌ VÀ TÊN" ];

    var _NHAPEMAIL = [ "NHẬP EMAIL" ];

    var _NHAPEMAILCUABAN = [ "Nhập email của bạn" ];

    var _NHAPSODIENTHOAI = [ "NHẬP SỐ ĐIỆN THOẠI" ];

    var _NOIDUNG = [ "NỘI DUNG" ];

    var _NHAPMACAPCHA = [ "NHẬP MÃ CAPCHA" ];
