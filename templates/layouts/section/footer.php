                        ...
                        <form action="" method="post" id="form_footer" enctype="multipart/form-data">
                            <div class="form-item footer d-flex">
                                <div class="form-item_left">
                                    <input type="text" class="txt" name="data[email]" data-validate autocomplete="off" id="mailfooter"
                ...
                <div class="row">
                        ...
                        <ul>
                            ...
                            <li class="pt15">
                                <a href="<?= $value['type']?>/<?= $value['tenkhongdau'] ?>" class="colorwhite thongtinFooter">
                                    <img src="assets/images/homedecor/muiten.png" class="pr7 responMUITEN"/>
                                    <?=htmlspecialchars_decode($value['ten'])?>

                                </a>
                            </li>
                            <?php }?>
                            <li class="pt15"><img src="<?= _upload_hinhanh_l.$bct['photo']?>" alt="" class="responBCT"></li>
                    ...
                    <div class="col-2 item pt15 pb50 mobicol-12 wow fadeInUp mb-m-20" data-wow-delay="0.2s">
                        <ul>
                            ...
                            <li>
                                <a href="dich-vu" class="colorwhite thongtinFooter">
                                    <img src="assets/images/homedecor/muiten.png"  class="pr7 responMUITEN"/>
                                    Dịch vụ
                    ...
                    <div class="col-3 item width100mobile pt15 pb50 wow fadeInRight mb-m-20" data-wow-delay="0.2s">
                        ...
                        <ul class="pt10 justycenter" style="display: flex;">
                            ...
                            <li>
                                <a href="<?=$value['link']?>">
                                    <img src="<?=_upload_hinhanh_l.$value['photo']?>"  class="responMXH"/>
                                </a>
                            </li>
                            <?php }?>
...
<div class="call-me-now d-none d-block-m">
    <a class="hotline-popup zalol" target="_blank" rel="nofollow"
        href="http://zalo.me/<?=str_replace('.','',str_replace(' ','',$row_setting['sozalo']))?>"><span></span></a>
</div>
