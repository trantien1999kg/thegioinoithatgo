<?php
    $slider=$db->rawQuery("select ten_$lang as ten, mota_$lang as mota , linh_vuc ,photo_$lang photo,link,nam,linh_vuc from #_photo where hienthi=1 and type=? order by stt asc,id desc",array('slider'));
                        ...
                        <div class='title chayten'>
                            ...
                            <div class='box-slider_content mt-50'>
                                ...
                                <div class="bocngoaimota wow slideInRight" data-wow-delay="0.5s">
                                    <div class="descSlide">
                                        <?=htmlspecialchars_decode($slider[$i]['mota'])?>
                                    </div>
                                </div>

                                <div class="buttonSlide wow slideInUp" data-wow-delay="0.5s">
                                    
                                    <a href="<?= $slider[$i]['link']?>" class="borderGT pd2">
                                        <div class="f1GT pd2">
