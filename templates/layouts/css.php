...
<?php
    ...
    $css->setCss("./assets/css/w600.css");

    $css->setCss("./assets/css/w400.css");
...
src: url('assets/images/fonts/HELGA.OTF') format('truetype');
...
:root {
    ...
    --html-bg-website-o: <?=$row_setting['color_page']."c7" ?>;

    --html-cl-website: <?=$row_setting['color_text']?>;

    --html-cl-website-o: <?=$row_setting['color_text']."f5"?>;
