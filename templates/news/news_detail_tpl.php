<section class="products-page container">
    <div class="grid wide">
        <div class="row">
            ...
            <div class="col l-12 col-12 m-12 c-12" style="margin-bottom:0 !important;">
        ...
        <div class="flex-row display-flex">
            <?php if($row_toc==1 && $deviceType=='computer'){?>
            <div class="item col__left z-100m col-12mobile">
                <div class="sidebar__sticky">
                    <div class="wrapper-toc mt50">
            ...
            <?php 
                ...
                $col_right = ($row_toc==1 && $deviceType=='computer') ? 'z-100m' : 'col-12';
    
            ?>
            <div class="item col-12mobile <?=$col_right?>">
                            ...
                            <div class="i-shareLinks i-other-news pd10 mb10 colorf4">
                                ...
                                <ul class="i-list-news-other">
                                    ...
                                    <li style="margin-top: 10px; margin-bottom: 10px;">
                                        <i class="fas fa-light fa-angles-right"></i><a class="text-decoration-none"
                                            href="<?=$other["type"]?>/<?=$other["tenkhongdau"]?>"
